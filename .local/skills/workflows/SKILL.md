...
- **webview** - For web applications. MUST use port 2000.
...
**Supported Ports:** 3000, 3001, 3002, 3003, 4200, 2000 (webview only), 5173, 6000, 6800, 8000, 8008, 8080, 8099, 9000
...
5. **Port 2000 for web apps**: Always use port 2000 with webview output type
...
- **Port/output type mismatch**: Port 2000 requires webview, webview requires port 2000
